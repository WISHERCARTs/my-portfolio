...
const projects = [
    {
        ...
        description: "A web application to manage university clubs with AI-driven recommendations for events and member engagement tracking.",
    ...
    },
    {
        ...
        description: "Interactive dashboard visualizing complex datasets using Python and Streamlit, providing actionable insights for business decision making.",
        image: "https://placehold.co/600x400/png",
    ...
    },
    {
        ...
        description: "An automation system built with n8n to streamline daily tasks and integrate various API services efficiently.",
        image: "https://placehold.co/600x400/png",
        tags: ["n8n", "JavaScript", "API Integration", "Docker"],
        github: "#",
        demo: "#"
    }
];
    ...
    return (
        <Section id="projects" className="bg-slate-50 dark:bg-slate-900/50">
            ...
            >
                ...
                <p className="text-slate-600 dark:text-slate-400">Some of the projects I've worked on</p>
            </motion.div>
