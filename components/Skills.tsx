...
const skillsData = [
    ...
    },
    {
        ...
        items: ["Pandas", "NumPy", "Scikit-learn", "Matplotlib", "TensorFlow (Basic)"]
    },
    {
    ...
    return (
        <Section id="skills">
            ...
            >
                ...
                <p className="text-slate-600 dark:text-slate-400">My technical toolkit and areas of expertise</p>
            </motion.div>
